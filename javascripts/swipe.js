    ...
    function startanima(layerid,show){
        ...
        if(show){ 
            ...
            setTimeout(function(){
                ...
                map2toplayerdiv.style['-webkit-transition']= 'all 20s 2s linear';
                map2toplayerdiv.style['-moz-transition']= 'all 20s 2s linear' ;
                map2toplayerdiv.style['transition']= 'all 20s 2s linear'  ;  
        ...
        else
        {
            ...
            map2toplayerdiv.style['-webkit-transition']= 'all 2s linear';
            map2toplayerdiv.style['-moz-transition']= 'all 2s linear'
            map2toplayerdiv.style['transition']= 'all 2s linear'        
            map2toplayerdiv.style.clip='rect('+cliptop+','+clipright+','+clipbottom+','+clipleft+')';
            }, 10);
        }
    }
